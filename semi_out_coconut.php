...
<header>
  ...
  <section class="section">
    ...
    <ul class="main">
            <li><a href="semi_out_carabao.php">SEMI คาราบาว</a></li>
            <li><a href="semi_out_coffee.php">SEMI กาแฟ</a></li>
            <li><a href="semi_out_coconut.php">SEMI น้ำมะพร้าว</a></li>
            <li><a href="semi_out_light.php">SEMI C light</a></li>
            <li><a href="semi_out_etc.php">SEMI Etc</a></li>
        </ul>
          <form action="">
            <fieldset>
              <legend>จ่ายออกสินค้า SEMI น้ำมะพร้าว</legend><br>
