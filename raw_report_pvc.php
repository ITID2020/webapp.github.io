<?php
    ...
    $sql = "SELECT * FROM pvc_in ORDER BY id asc limit {$start} , {$perpage}" or die("Error:" . mysqli_error()); 
...
<head>
    ...
    <title>รายการวัตถุดิบที่รับเข้า PVC บวกเบ็ดเตล็ด</title>
    ...
    ?>
            ...
            <br>
                ...
                ?>
                  ...
                  <ul class="pagination">
                    <li>
                      <a href="raw_report_pvc.php?page=1" aria-label="Previous">
                      <span aria-hidden="true">&laquo;</span>
                      </a>
                      </li>
                      <?php for($i=1;$i<=$total_page;$i++) { ?>
                      <li><a href="raw_report_pvc.php?page=<?php echo $i; ?>"><?php echo $i; ?></a></li>
                      <?php } ?>
                      <li>
                      <a href="raw_report_pvc.php?page=<?php echo $total_page;?>" aria-label="Next">
