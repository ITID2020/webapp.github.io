<?php
    ...
    $sql = "SELECT * FROM จ่ายออก_กระป๋องกับฝา ORDER BY id asc limit {$start} , {$perpage}" or die("Error:" . mysqli_error()); 
...
<head>
    ...
    <title>รายการวัตถุดิบที่จ่ายออก</title>
...
<tr>
            ...
            <br>
                ...
                <?php
                $sql1 = "select * from จ่ายออก_กระป๋องกับฝา ";
                ...
                ?>
                  ...
                  <ul class="pagination">
                    <li>
                      <a href="raw_report_out_canned_lid.php?page=1" aria-label="Previous">
                      <span aria-hidden="true">&laquo;</span>
                      </a>
                      </li>
                      <?php for($i=1;$i<=$total_page;$i++){ ?>
                      <li><a href="raw_report_out_canned_lid.php?page=<?php echo $i; ?>"><?php echo $i; ?></a></li>
                      <?php } ?>
                      <li>
                      <a href="raw_report_out_canned_lid.php?page=<?php echo $total_page;?>" aria-label="Next">
