...
<head>
    ...
    <title>รับเข้าวัตถุดิบกระป๋องกับฝา</title>
...
<header>
  ...
  <ul>
    ...
    <ul class="main">
        ...
        <form method="POST" action="session_raw_material_canned.php" >
            <fieldset>
              <legend>รับเข้าสินค้า กระป๋องกับฝา</legend><br>

                <label for="name">ชื่อสินค้า :</label>

                <?php
                        $sql = "select * from กระป๋องกับฝา";
