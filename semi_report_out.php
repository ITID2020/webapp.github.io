...
<body>
    ...
    <ul>
        ...
        <ul class="main">
            <li><a href="semi_report_out_carabao.php">SEMI คาราบาว</a></li>
            <li><a href="semi_report_out_coffee.php">SEMI กาแฟ</a></li>
            <li><a href="semi_report_out_coconut.php">SEMI น้ำมะพร้าว</a></li>
            <li><a href="semi_report_out_light.php">SEMI C light</a></li>
            <li><a href="semi_report_out_etc.php">SEMI Etc</a></li>
        </ul><br>
          <form action="">
            
           <br><br>
           <h1>รายการจ่ายออก SEMI</h1>
           <br><br>
          </form>
        </article>
        </section>
