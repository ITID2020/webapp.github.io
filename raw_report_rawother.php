<?php
    ...
    $sql = "SELECT * FROM รับเข้า_วัตถุดิบ ORDER BY id asc limit {$start} , {$perpage}" or die("Error:" . mysqli_error()); 
...
<head>
    ...
    <title>รายการวัตถุดิบที่รับเข้าวัตถุดิบ อื่นๆ</title>
  ...
  <ul>
    ...
    ?>
            ...
            <br>
                ...
                <?php
                $sql1 = "select * from รับเข้า_วัตถุดิบ ";
                ...
                ?>
                  ...
                  <ul class="pagination">
                    <li>
                      <a href="raw_report_rawother.php?page=1" aria-label="Previous">
                      <span aria-hidden="true">&laquo;</span>
                      </a>
                      </li>
                      <?php for($i=1;$i<=$total_page;$i++){ ?>
                      <li><a href="raw_report_rawother.php?page=<?php echo $i; ?>"><?php echo $i; ?></a></li>
                      <?php } ?>
                      <li>
                      <a href="raw_report_rawother.php?page=<?php echo $total_page;?>" aria-label="Next">
