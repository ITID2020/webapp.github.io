...
<body>
    ...
    <ul>
        ...
        <ul class="main">
            <li><a href="fg_conclude_carabao.php">FG คาราบาว</a></li>
            <li><a href="fg_conclude_coffee.php">FG กาแฟ</a></li>
            <li><a href="fg_conclude_coconut.php">FG น้ำมะพร้าว</a></li>
            <li><a href="fg_conclude_clight.php">FG C light</a></li>
            <li><a href="fg_conclude_etc.php">FG Etc</a></li>
        </ul><br>
          <form action="">
