...
/*
    ...
    $sql = "SELECT * FROM pvc_in 
    INNER JOIN จ่ายออก_pvcบวกเบ็ดเตล็ด ON pcv_in.po = จ่ายออก_pvcบวกเบ็ดเตล็ด.id ORDER BY id asc limit {$start} , {$perpage}" or die("Error:" . mysqli_error()); 
    $q = mysqli_query($link, $sql); 
*/

    $sql = " SELECT * FROM pvc_in ORDER BY id asc " or die("Error:" . mysqli_error()); 
            ...
            <br>
               ...
               <?php
                ...
                ?>
                  ...
                  <ul class="pagination">
                    <li>
                      <a href="raw_report_bottle.php?page=1" aria-label="Previous">
                      <span aria-hidden="true">&laquo;</span>
                      </a>
                      </li>
                      <?php for($i=1;$i<=$total_page;$i++){ ?>
                      <li><a href="raw_report_bottle.php?page=<?php echo $i; ?>"><?php echo $i; ?></a></li>
                      <?php } ?>
                      <li>
                      <a href="raw_report_bottle.php?page=<?php echo $total_page;?>" aria-label="Next">
