...
<body>
    ...
    <ul>
        ...
        <ul class="main">
            <li><a href="fg_report_carabao.php">FG คาราบาว</a></li>
            <li><a href="fg_report_coffee.php">FG กาแฟ</a></li>
            <li><a href="fg_report_coconut.php">FG น้ำมะพร้าว</a></li>
            <li><a href="fg_report_clight.php">FG C light</a></li>
            <li><a href="fg_report_etc.php">FG Etc</a></li>
        </ul><br>
          <form action="">
