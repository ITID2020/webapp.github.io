...
<head>
    ...
    <title>จ่ายออกวัตถุดิบ PVC บวกเบ็ดเตล็ด</title>
...
<header>
  ...
  <ul>
    ...
    <ul class="main">
          <li><a href="raw_material_out_pvc.php">PVC บวกเบ็ดเตล็ด</a></li>
          <li><a href="raw_material_out_canned_lid.php">กระป๋องกับฝา</a></li>
          <li><a href="raw_material_out_smell.php">กลิ่น</a></li>
          <li><a href="raw_material_out_box.php">กล่อง</a></li>
          <li><a href="raw_material_out_bottle.php">ขวด</a></li>
          <li><a href="raw_material_out_lot.php">ฉลาก</a></li>
          <li><a href="raw_material_out_tray.php">ถาด</a></li>
          <li><a href="raw_material_out_bag.php">ถุง</a></li>
          <li><a href="raw_material_out_additives.php">สาร</a></li>
          <li><a href="raw_material_out_rawother.php">วัตถุดิบอื่น ๆ</a></li>
        </ul>

          <form method="POST" action="session_raw_material_out_pvc.php" >
            <fieldset>
              <legend>จ่ายออกสินค้า PVC บวกเบ็ดเตล็ด</legend><br>
                <label for="name">ชื่อสินค้า :</label>
                <?php
                        $sql = "select * from pvc_sy";
                ...
                <label for="numpro">จำนวนที่จ่ายออก :</label>
                ...
                <label for="date">วันที่จ่ายออก :</label>
