...
<header>
  ...
  <section class="section">
    ...
    <ul class="main">
            <li><a href="fg_in_carabao.php">FG คาราบาว</a></li>
            <li><a href="fg_in_coffee.php">FG กาแฟ</a></li>
            <li><a href="fg_in_coconut.php">FG น้ำมะพร้าว</a></li>
            <li><a href="fg_in_clight.php">FG C light</a></li>
            <li><a href="fg_in_etc.php">FG Etc</a></li>
        </ul>
          <form action="">
            <fieldset>
